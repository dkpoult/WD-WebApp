...
@Component({
  ...
  templateUrl: './bookable-session-form.component.html',
  styleUrls: ['./bookable-session-form.component.scss'],
  animations: [
    trigger(
      'fade',
      [
...
export class BookableSessionFormComponent implements OnInit {
